...
var ListComponent = (function () {
    function ListComponent(assetService, router, route, datePipe) {
     ...
     * @returns {Array}
     */
    ListComponent.prototype.createDataRows = function (assets) {
        var updatedAssets = [];
        for (var i in assets) {
            updatedAssets.push({
                _id: assets[i]._id,
    ...
    ], ListComponent.prototype, "allocatedAssetsList", void 0);
...
//# sourceMappingURL=list-asset.component.js.map
